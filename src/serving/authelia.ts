        ...
        const configSecret = new FileSecret(`${name}-config`, {
            spec: {
                ...
                encryptedData: {
                    ...
                    OIDC_CLIENTS_SPLITPRO_ID: "",
                    OIDC_CLIENTS_SPLITPRO_SECRET: "",

                    // matrix (continuwuity). The SECRET is a pbkdf2-sha512
                    // digest in passlib's adapted base64 (`+` becomes `.`,
                    // standard base64 is rejected); the plaintext side lives in
                    // the matrix namespace's own sealed secret
                    // (src/matrix/index.ts).
                    OIDC_CLIENTS_MATRIX_ID: "",
                    OIDC_CLIENTS_MATRIX_SECRET: "",
                }
            }
        }, { parent: this });
