        ...
        const configSecret = new FileSecret(`${name}-config`, {
            spec: {
                ...
                encryptedData: {
                    ...
                    // digest; the plaintext side lives in the matrix
                    // namespace's own sealed secret (src/matrix/index.ts).
                    ...
                    OIDC_CLIENTS_MATRIX_SECRET: "",
                }
            }
        }, { parent: this });
