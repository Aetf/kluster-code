...
export class FpgaDevicePlugin extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.deviceplugin.v1.FpgaDevicePluginSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.deviceplugin.v1.FpgaDevicePluginStatus>;
...
export interface FpgaDevicePluginArgs {
    ...
    spec?: pulumi.Input<inputs.deviceplugin.v1.FpgaDevicePluginSpec | undefined>;
}
