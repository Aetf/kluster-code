...
export class ObjectStore extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ObjectStore {
        return new ObjectStore(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:barmancloud.cnpg.io/v1:ObjectStore';
    ...
    declare public readonly spec: pulumi.Output<outputs.barmancloud.v1.ObjectStoreSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.barmancloud.v1.ObjectStoreStatus>;
