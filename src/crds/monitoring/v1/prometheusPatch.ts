 ...
 */
export class PrometheusPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrometheusPatch {
        return new PrometheusPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:monitoring.coreos.com/v1:PrometheusPatch';

    /**
     * Returns true if the given object is an instance of PrometheusPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PrometheusPatch {
    ...
    declare public readonly spec: pulumi.Output<outputs.monitoring.v1.PrometheusSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.monitoring.v1.PrometheusStatusPatch>;
...
export interface PrometheusPatchArgs {
    ...
    spec?: pulumi.Input<inputs.monitoring.v1.PrometheusSpecPatch | undefined>;
}
