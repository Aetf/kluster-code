 ...
 */
export class ThanosRulerPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ThanosRulerPatch {
        return new ThanosRulerPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:monitoring.coreos.com/v1:ThanosRulerPatch';

    /**
     * Returns true if the given object is an instance of ThanosRulerPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ThanosRulerPatch {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ThanosRulerPatch.__pulumiType;
    }
    ...
    declare public readonly spec: pulumi.Output<outputs.monitoring.v1.ThanosRulerSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.monitoring.v1.ThanosRulerStatusPatch>;
    ...
    constructor(name: string, args?: ThanosRulerPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ThanosRulerPatch.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface ThanosRulerPatchArgs {
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"ThanosRuler" | undefined>;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    metadata?: pulumi.Input<inputs.meta.v1.ObjectMetaPatch | undefined>;
    spec?: pulumi.Input<inputs.monitoring.v1.ThanosRulerSpecPatch | undefined>;
}
