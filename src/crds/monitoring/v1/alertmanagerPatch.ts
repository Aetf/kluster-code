 ...
 */
export class AlertmanagerPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AlertmanagerPatch {
        return new AlertmanagerPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:monitoring.coreos.com/v1:AlertmanagerPatch';

    /**
     * Returns true if the given object is an instance of AlertmanagerPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AlertmanagerPatch {
    ...
    declare public readonly spec: pulumi.Output<outputs.monitoring.v1.AlertmanagerSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.monitoring.v1.AlertmanagerStatusPatch>;
...
export interface AlertmanagerPatchArgs {
    ...
    spec?: pulumi.Input<inputs.monitoring.v1.AlertmanagerSpecPatch | undefined>;
}
