 ...
 */
export class PodMonitorPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PodMonitorPatch {
        return new PodMonitorPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:monitoring.coreos.com/v1:PodMonitorPatch';

    /**
     * Returns true if the given object is an instance of PodMonitorPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PodMonitorPatch {
    ...
    declare public readonly spec: pulumi.Output<outputs.monitoring.v1.PodMonitorSpecPatch>;
...
export interface PodMonitorPatchArgs {
    ...
    spec?: pulumi.Input<inputs.monitoring.v1.PodMonitorSpecPatch | undefined>;
}
