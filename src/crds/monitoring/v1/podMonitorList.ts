 ...
 */
export class PodMonitorList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PodMonitorList {
        return new PodMonitorList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:monitoring.coreos.com/v1:PodMonitorList';

    /**
     * Returns true if the given object is an instance of PodMonitorList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PodMonitorList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === PodMonitorList.__pulumiType;
    }
     ...
     */
    declare public readonly items: pulumi.Output<outputs.monitoring.v1.PodMonitor[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"PodMonitorList">;
    /**
    ...
    constructor(name: string, args?: PodMonitorListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "PodMonitorList";
        ...
        super(PodMonitorList.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface PodMonitorListArgs {
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"PodMonitorList" | undefined>;
    /**
     * Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
