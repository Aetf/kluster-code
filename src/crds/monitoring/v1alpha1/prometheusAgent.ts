 ...
 */
export class PrometheusAgent extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): PrometheusAgent {
        return new PrometheusAgent(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:monitoring.coreos.com/v1alpha1:PrometheusAgent';

    /**
     * Returns true if the given object is an instance of PrometheusAgent.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PrometheusAgent {
    ...
    declare public readonly spec: pulumi.Output<outputs.monitoring.v1alpha1.PrometheusAgentSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.monitoring.v1alpha1.PrometheusAgentStatus>;
...
export interface PrometheusAgentArgs {
    ...
    spec?: pulumi.Input<inputs.monitoring.v1alpha1.PrometheusAgentSpec | undefined>;
}
