...
export class IngressRouteTCP extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.traefik.v1alpha1.IngressRouteTCPSpec>;
...
export interface IngressRouteTCPArgs {
    ...
    spec?: pulumi.Input<inputs.traefik.v1alpha1.IngressRouteTCPSpec | undefined>;
}
