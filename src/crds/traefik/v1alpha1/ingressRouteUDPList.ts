 ...
 */
export class IngressRouteUDPList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IngressRouteUDPList {
        return new IngressRouteUDPList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:traefik.io/v1alpha1:IngressRouteUDPList';

    /**
     * Returns true if the given object is an instance of IngressRouteUDPList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IngressRouteUDPList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IngressRouteUDPList.__pulumiType;
    }
     ...
     */
    declare public readonly items: pulumi.Output<outputs.traefik.v1alpha1.IngressRouteUDP[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"IngressRouteUDPList">;
    /**
    ...
    constructor(name: string, args?: IngressRouteUDPListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "IngressRouteUDPList";
        ...
        super(IngressRouteUDPList.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface IngressRouteUDPListArgs {
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"IngressRouteUDPList" | undefined>;
    /**
     * Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
