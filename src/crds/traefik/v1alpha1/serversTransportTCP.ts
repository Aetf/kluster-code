...
export class ServersTransportTCP extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.traefik.v1alpha1.ServersTransportTCPSpec>;
...
export interface ServersTransportTCPArgs {
    ...
    spec?: pulumi.Input<inputs.traefik.v1alpha1.ServersTransportTCPSpec | undefined>;
}
