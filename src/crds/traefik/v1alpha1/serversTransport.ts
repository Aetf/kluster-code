...
export class ServersTransport extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.traefik.v1alpha1.ServersTransportSpec>;
...
export interface ServersTransportArgs {
    ...
    spec?: pulumi.Input<inputs.traefik.v1alpha1.ServersTransportSpec | undefined>;
}
