...
export class MiddlewareTCP extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): MiddlewareTCP {
        return new MiddlewareTCP(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is MiddlewareTCP {
    ...
    declare public readonly spec: pulumi.Output<outputs.traefik.v1alpha1.MiddlewareTCPSpec>;
    ...
    constructor(name: string, args?: MiddlewareTCPArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(MiddlewareTCP.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface MiddlewareTCPArgs {
    ...
    spec?: pulumi.Input<inputs.traefik.v1alpha1.MiddlewareTCPSpec | undefined>;
}
