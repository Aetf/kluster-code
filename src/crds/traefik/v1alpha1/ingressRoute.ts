...
export class IngressRoute extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.traefik.v1alpha1.IngressRouteSpec>;
...
export interface IngressRouteArgs {
    ...
    spec?: pulumi.Input<inputs.traefik.v1alpha1.IngressRouteSpec | undefined>;
}
