 ...
 */
export class IngressRouteUDP extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IngressRouteUDP {
        return new IngressRouteUDP(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is IngressRouteUDP {
    ...
    declare public readonly spec: pulumi.Output<outputs.traefik.v1alpha1.IngressRouteUDPSpec>;
     ...
     */
    constructor(name: string, args?: IngressRouteUDPArgs, opts?: pulumi.CustomResourceOptions) {
...
export interface IngressRouteUDPArgs {
    ...
    spec?: pulumi.Input<inputs.traefik.v1alpha1.IngressRouteUDPSpec | undefined>;
}
