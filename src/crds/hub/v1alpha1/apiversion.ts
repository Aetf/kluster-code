...
export class APIVersion extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:hub.traefik.io/v1alpha1:APIVersion';
    ...
    declare public readonly spec: pulumi.Output<outputs.hub.v1alpha1.APIVersionSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.hub.v1alpha1.APIVersionStatus>;
...
export interface APIVersionArgs {
    ...
    spec?: pulumi.Input<inputs.hub.v1alpha1.APIVersionSpec | undefined>;
}
