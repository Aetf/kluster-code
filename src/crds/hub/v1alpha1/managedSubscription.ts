...
export class ManagedSubscription extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.hub.v1alpha1.ManagedSubscriptionSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.hub.v1alpha1.ManagedSubscriptionStatus>;
