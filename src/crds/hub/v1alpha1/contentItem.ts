...
export class ContentItem extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:hub.traefik.io/v1alpha1:ContentItem';
    ...
    declare public readonly spec: pulumi.Output<outputs.hub.v1alpha1.ContentItemSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.hub.v1alpha1.ContentItemStatus>;
...
export interface ContentItemArgs {
    ...
    spec?: pulumi.Input<inputs.hub.v1alpha1.ContentItemSpec | undefined>;
}
