...
export class APIPortal extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:hub.traefik.io/v1alpha1:APIPortal';
    ...
    declare public readonly spec: pulumi.Output<outputs.hub.v1alpha1.APIPortalSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.hub.v1alpha1.APIPortalStatus>;
...
export interface APIPortalArgs {
    ...
    spec?: pulumi.Input<inputs.hub.v1alpha1.APIPortalSpec | undefined>;
}
