...
export class AccessControlPolicy extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.hub.v1alpha1.AccessControlPolicySpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.hub.v1alpha1.AccessControlPolicyStatus>;
