...
export class AccessControlPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): AccessControlPolicy {
        return new AccessControlPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:hub.traefik.io/v1alpha1:AccessControlPolicy';
    ...
    declare public readonly spec: pulumi.Output<outputs.hub.v1alpha1.AccessControlPolicySpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.hub.v1alpha1.AccessControlPolicyStatus>;
...
export interface AccessControlPolicyArgs {
    ...
    spec?: pulumi.Input<inputs.hub.v1alpha1.AccessControlPolicySpec | undefined>;
}
