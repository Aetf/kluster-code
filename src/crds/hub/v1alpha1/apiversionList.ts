 ...
 */
export class APIVersionList extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): APIVersionList {
        return new APIVersionList(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:hub.traefik.io/v1alpha1:APIVersionList';

    /**
     * Returns true if the given object is an instance of APIVersionList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is APIVersionList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === APIVersionList.__pulumiType;
    }
     ...
     */
    declare public readonly items: pulumi.Output<outputs.hub.v1alpha1.APIVersion[]>;
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    declare public readonly kind: pulumi.Output<"APIVersionList">;
    /**
    ...
    constructor(name: string, args?: APIVersionListArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["kind"] = "APIVersionList";
        ...
        super(APIVersionList.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface APIVersionListArgs {
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"APIVersionList" | undefined>;
    /**
     * Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
