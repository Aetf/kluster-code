...
export class SealedSecret extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.bitnami.v1alpha1.SealedSecretSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.bitnami.v1alpha1.SealedSecretStatus>;
...
export interface SealedSecretArgs {
    ...
    spec?: pulumi.Input<inputs.bitnami.v1alpha1.SealedSecretSpec | undefined>;
}
