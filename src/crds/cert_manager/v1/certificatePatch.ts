...
export class CertificatePatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.cert_manager.v1.CertificateSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cert_manager.v1.CertificateStatusPatch>;
