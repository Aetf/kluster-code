...
export class IssuerPatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.cert_manager.v1.IssuerSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cert_manager.v1.IssuerStatusPatch>;
