...
export class CertificateRequestPatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.cert_manager.v1.CertificateRequestSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cert_manager.v1.CertificateRequestStatusPatch>;
...
export interface CertificateRequestPatchArgs {
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"CertificateRequest" | undefined>;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    metadata?: pulumi.Input<inputs.meta.v1.ObjectMetaPatch | undefined>;
    spec?: pulumi.Input<inputs.cert_manager.v1.CertificateRequestSpecPatch | undefined>;
}
