...
export class ClusterIssuerPatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.cert_manager.v1.ClusterIssuerSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.cert_manager.v1.ClusterIssuerStatusPatch>;
