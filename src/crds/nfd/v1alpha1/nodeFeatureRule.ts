...
export class NodeFeatureRule extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.nfd.v1alpha1.NodeFeatureRuleSpec>;
...
export interface NodeFeatureRuleArgs {
    ...
    spec?: pulumi.Input<inputs.nfd.v1alpha1.NodeFeatureRuleSpec | undefined>;
}
