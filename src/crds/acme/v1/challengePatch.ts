...
export class ChallengePatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.acme.v1.ChallengeSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.acme.v1.ChallengeStatusPatch>;
...
export interface ChallengePatchArgs {
    ...
    spec?: pulumi.Input<inputs.acme.v1.ChallengeSpecPatch | undefined>;
}
