...
export class TLSRoute extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha3.TLSRouteSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha3.TLSRouteStatus>;
    ...
    constructor(name: string, args?: TLSRouteArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:gateway.networking.k8s.io/v1:TLSRoute" }, { type: "kubernetes:gateway.networking.k8s.io/v1alpha2:TLSRoute" }] };
