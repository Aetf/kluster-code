...
export class BackendTLSPolicy extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha3.BackendTLSPolicySpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha3.BackendTLSPolicyStatus>;
