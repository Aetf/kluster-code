...
export class BackendTLSPolicyPatch extends pulumi.CustomResource {
     ...
     */
    declare public readonly kind: pulumi.Output<"BackendTLSPolicy">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha3.BackendTLSPolicySpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha3.BackendTLSPolicyStatusPatch>;
...
export interface BackendTLSPolicyPatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1alpha3.BackendTLSPolicySpecPatch | undefined>;
}
