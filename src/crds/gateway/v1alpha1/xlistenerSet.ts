...
export class XListenerSet extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha1.XListenerSetSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha1.XListenerSetStatus>;
