...
export class XBackendTrafficPolicyPatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha1.XBackendTrafficPolicySpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha1.XBackendTrafficPolicyStatusPatch>;
...
export interface XBackendTrafficPolicyPatchArgs {
     ...
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
    kind?: pulumi.Input<"XBackendTrafficPolicy" | undefined>;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    metadata?: pulumi.Input<inputs.meta.v1.ObjectMetaPatch | undefined>;
    spec?: pulumi.Input<inputs.gateway.v1alpha1.XBackendTrafficPolicySpecPatch | undefined>;
}
