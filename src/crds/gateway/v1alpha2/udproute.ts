...
export class UDPRoute extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha2.UDPRouteSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha2.UDPRouteStatus>;
