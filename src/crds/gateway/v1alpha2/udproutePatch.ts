...
export class UDPRoutePatch extends pulumi.CustomResource {
     ...
     */
    declare public readonly kind: pulumi.Output<"UDPRoute">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha2.UDPRouteSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha2.UDPRouteStatusPatch>;
...
export interface UDPRoutePatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1alpha2.UDPRouteSpecPatch | undefined>;
}
