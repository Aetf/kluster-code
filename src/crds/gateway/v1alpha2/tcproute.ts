...
export class TCPRoute extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1alpha2.TCPRouteSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1alpha2.TCPRouteStatus>;
