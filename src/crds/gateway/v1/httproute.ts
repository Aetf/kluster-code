...
export class HTTPRoute extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.HTTPRouteSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.HTTPRouteStatus>;
