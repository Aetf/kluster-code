...
export class ReferenceGrant extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.networking.k8s.io/v1:ReferenceGrant';
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.ReferenceGrantSpec>;
