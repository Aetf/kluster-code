...
export class GatewayClassPatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.GatewayClassSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.GatewayClassStatusPatch>;
...
export interface GatewayClassPatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1.GatewayClassSpecPatch | undefined>;
}
