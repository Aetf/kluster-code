...
export class GRPCRoute extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.GRPCRouteSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.GRPCRouteStatus>;
