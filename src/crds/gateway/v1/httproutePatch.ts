...
export class HTTPRoutePatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.HTTPRouteSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.HTTPRouteStatusPatch>;
...
export interface HTTPRoutePatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1.HTTPRouteSpecPatch | undefined>;
}
