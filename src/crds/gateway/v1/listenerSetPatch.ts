 ...
 */
export class ListenerSetPatch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ListenerSetPatch {
        return new ListenerSetPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.networking.k8s.io/v1:ListenerSetPatch';

    /**
     * Returns true if the given object is an instance of ListenerSetPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ListenerSetPatch {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.ListenerSetSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.ListenerSetStatusPatch>;
...
export interface ListenerSetPatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1.ListenerSetSpecPatch | undefined>;
}
