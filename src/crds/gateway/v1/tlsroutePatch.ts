...
export class TLSRoutePatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:gateway.networking.k8s.io/v1:TLSRoutePatch';
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.TLSRouteSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.TLSRouteStatusPatch>;
    ...
    constructor(name: string, args?: TLSRoutePatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:gateway.networking.k8s.io/v1alpha2:TLSRoutePatch" }, { type: "kubernetes:gateway.networking.k8s.io/v1alpha3:TLSRoutePatch" }] };
...
export interface TLSRoutePatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1.TLSRouteSpecPatch | undefined>;
}
