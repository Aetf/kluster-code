...
export class GRPCRoutePatch extends pulumi.CustomResource {
     ...
     */
    declare public readonly kind: pulumi.Output<"GRPCRoute">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.GRPCRouteSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.GRPCRouteStatusPatch>;
...
export interface GRPCRoutePatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1.GRPCRouteSpecPatch | undefined>;
}
