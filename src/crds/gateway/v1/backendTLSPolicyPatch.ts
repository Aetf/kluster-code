...
export class BackendTLSPolicyPatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1.BackendTLSPolicySpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1.BackendTLSPolicyStatusPatch>;
...
export interface BackendTLSPolicyPatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1.BackendTLSPolicySpecPatch | undefined>;
}
