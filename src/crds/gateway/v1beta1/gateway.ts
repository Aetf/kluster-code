...
export class Gateway extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1beta1.GatewaySpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1beta1.GatewayStatus>;
