...
export class HTTPRoute extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1beta1.HTTPRouteSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1beta1.HTTPRouteStatus>;
