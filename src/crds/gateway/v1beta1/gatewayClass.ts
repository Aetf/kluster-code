...
export class GatewayClass extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1beta1.GatewayClassSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1beta1.GatewayClassStatus>;
