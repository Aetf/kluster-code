...
export class HTTPRoutePatch extends pulumi.CustomResource {
     ...
     */
    declare public readonly kind: pulumi.Output<"HTTPRoute">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    declare public readonly spec: pulumi.Output<outputs.gateway.v1beta1.HTTPRouteSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1beta1.HTTPRouteStatusPatch>;
...
export interface HTTPRoutePatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1beta1.HTTPRouteSpecPatch | undefined>;
}
