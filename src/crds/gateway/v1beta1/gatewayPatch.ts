...
export class GatewayPatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.gateway.v1beta1.GatewaySpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.gateway.v1beta1.GatewayStatusPatch>;
...
export interface GatewayPatchArgs {
    ...
    spec?: pulumi.Input<inputs.gateway.v1beta1.GatewaySpecPatch | undefined>;
}
