...
export class DatabaseRole extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DatabaseRole {
        return new DatabaseRole(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:postgresql.cnpg.io/v1:DatabaseRole';
    ...
    declare public readonly spec: pulumi.Output<outputs.postgresql.v1.DatabaseRoleSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.postgresql.v1.DatabaseRoleStatus>;
...
export interface DatabaseRoleArgs {
    ...
    spec?: pulumi.Input<inputs.postgresql.v1.DatabaseRoleSpec | undefined>;
}
