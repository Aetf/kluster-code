...
export class Subscription extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.postgresql.v1.SubscriptionSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.postgresql.v1.SubscriptionStatus>;
