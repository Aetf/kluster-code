...
export class Subscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:postgresql.cnpg.io/v1:Subscription';
    ...
    declare public readonly spec: pulumi.Output<outputs.postgresql.v1.SubscriptionSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.postgresql.v1.SubscriptionStatus>;
...
export interface SubscriptionArgs {
    ...
    spec?: pulumi.Input<inputs.postgresql.v1.SubscriptionSpec | undefined>;
}
