...
export class Pooler extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Pooler {
        return new Pooler(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:postgresql.cnpg.io/v1:Pooler';

    /**
     * Returns true if the given object is an instance of Pooler.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Pooler {
    ...
    declare public readonly spec: pulumi.Output<outputs.postgresql.v1.PoolerSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.postgresql.v1.PoolerStatus>;
...
export interface PoolerArgs {
    ...
    spec?: pulumi.Input<inputs.postgresql.v1.PoolerSpec | undefined>;
}
